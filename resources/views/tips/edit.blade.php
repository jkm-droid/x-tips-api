...
@section('content')
    ...
    <div class="col-md-12">
        <form action="{{ route('tip.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="team_a" class="form-control" value="{{ $tip->team_a }}" aria-label="Team A">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="team_b" class="form-control" value="{{ $tip->team_b }}" aria-label="Team B">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="country_league" class="form-control" value="{{ $tip->country_league }}" aria-label="country_league">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <select name="correct_tip" id="correct_tip" class="form-select form-control" aria-label="Default select example" autofocus>
                        <option disabled>Select correct tip</option>
                        <option value="{{ $tip->correct_tip }}">{{ $tip->correct_tip }}</option>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" name="correct_odd" class="form-control" value="{{ $tip->correct_odd }}" id="correct_odd">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" name="other_score" class="form-control" value="{{ $tip->other_score}}" placeholder="Enter other score" id="inputotherscore">
            ...
            <div class="mb-3 mt-3 form-check">
                ...
                <label id="vip_status_label" class="form-check-label text-primary" for="vip_status"><strong>Change VIP status</strong></label>
            </div>

            <button type="submit" class="btn btn-secondary">Edit Tip</button>
        </form>
    </div>
@endsection
